...
for i = 1:length(basin_list)
    ...
    %basin_et_hydromodel = load(['/home/ca-lstm/hydromodel/',hydro_sel,'/trial_1/simaet_watershed/simaet_',hydro_sel,'_',basin_id,'.txt']);
    basin_et_hydromodel = load(['/home/ca-lstm/hydromodel/',hydro_sel,'/simsm_watershed/simsm_',hydro_sel,'_',basin_id,'.txt']);
...
save(['hybrid_lstm_',hydro_sel,'_SMin_epoch',num2str(num_epoch),'_drop',num2str(dropout_rate*100),'_trial',num2str(trial),'.mat'],...
